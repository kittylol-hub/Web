...
-- Compatible with Obsidian DependencyBox
-- ============================================================
local BulletTracerDep = GunBox:AddDependencyBox()
...
local BulletTracerToggle = BulletTracerDep:AddToggle("BulletTracer", {
    Text = "Bullet Tracer",
    Default = true,
    Callback = function(v)
...
local function HookBulletTracer()
    ...
    local ok = pcall(function()
        ...
        local tracerModule = modulesFolder
            and modulesFolder:FindFirstChild("TracerEffect")
...
BulletTracerDep:SetupDependencies({
    { BulletTracerToggle, true },
})
